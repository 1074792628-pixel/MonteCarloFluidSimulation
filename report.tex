...
本实验尝试运行该 cohomology 场景，但即使降低分辨率（$64\times64$），复杂六边形边界的 VPL 路径积分仍非常耗时，未能在有限时间内完成完整演示。因此，关于复杂边界的优势主要依据论文的验证与理论分析。这一差异体现了两种方法的设计哲学：涡量法以物理守恒换取简单性，在单连通平滑域上高效；速度法以投影代价换取对复杂几何的鲁棒性。
